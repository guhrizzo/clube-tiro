        ...
        {loading ? (
          ...
          <div className="columns-1 sm:columns-2 lg:columns-3 gap-6 space-y-6">
            {filteredPhotos.length === 0 && (
              <p className="text-gray-400 italic text-center col-span-full py-10">Nenhuma foto encontrada nesta categoria.</p>
            )}
            ...
            {filteredPhotos.map((photo) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-linear-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-end p-8">
      ...
      {selectedPhotoIndex !== null && photos[selectedPhotoIndex] && (
        <div className="fixed inset-0 z-110 bg-black/95 flex items-center justify-center p-4 backdrop-blur-md">
          <button 
            ...
            className="absolute top-6 right-6 text-white/70 cursor-pointer hover:text-[#ffb703] transition-colors z-120"
          >
            <X size={40} />
          </button>

          <button onClick={prevPhoto} className="absolute left-4 text-white hover:text-[#ffb703] p-2 transition-all z-120">
            <ChevronLeft size={48} />
          </button>
          ...
          <button onClick={nextPhoto} className="absolute right-4 text-white hover:text-[#ffb703] p-2 cursor-pointer transition-all z-120">
