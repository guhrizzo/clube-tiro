...
export default function ContractModal({ isOpen, onClose }: ContractModalProps) {
  ...
  const labelCls = "block text-[11px] uppercase tracking-widest text-gray-500 mb-1";
        ...
        <div className="flex-[1.6] flex flex-col overflow-hidden border-r border-gray-200">
          ...
          <div className="flex-1 overflow-y-auto bg-gray-50 px-6 py-8" ref={scrollRef}>
            <div className="max-w-170 mx-auto bg-white border border-gray-200 px-10 py-12 text-[13px] text-gray-800 leading-relaxed font-serif shadow-sm">
              ...
              <p className="mb-3">
                <strong>CLÁUSULA PRIMEIRA:</strong> O valor total do contrato, correspondente à cota {p.nomeContrato} (vigente por {p.nomePrazo} anos), é de <strong>{p.total}</strong>, ficando isento o pagamento de taxa de contribuição social mensal.
              </p>
              <p className="mb-3">
              ...
              <p className="mb-3">
                <strong>CLÁUSULA DÉCIMA:</strong> Zelar pelo patrimônio do clube, responsabilizando-se por si e por seus convidados, inclusive por danos ou despesas que venham a causar. É <strong>expressamente proibido que menores de 18 anos</strong> manuseiem, utilizem ou portem qualquer tipo de arma de fogo, à exceção daqueles com autorização judicial.
              </p>
              <p className="mb-3">
                <strong>CLÁUSULA ONZE:</strong> Pagar pontualmente as parcelas para quitação do título {p.nomeContrato} de sócio usuário (colaborador), quando parcelado.
              </p>
              <p className="mb-3">
              ...
              <p className="mb-3">
                <strong>CLÁUSULA DEZOITO:</strong> O sócio declara ter ciência de que CACs <strong>não possuem autorização para PORTE de arma</strong>, e sim, alguns deles, para POSSE e TRANSPORTE da arma, munições e acessórios de casa até os locais de competição, clubes de tiro, treinamentos e outros, autorizados pelas GUIAS DE TRÁFEGO.
              </p>
              <p className="mb-3">
              ...
              <p className="mb-3">
                <strong>PARÁGRAFO SEGUNDO:</strong> Em caso de rescisão ou cancelamento deste contrato, a parte que der ensejo à rescisão deverá pagar à outra parte <strong>30% (trinta por cento)</strong> do valor da cota {p.nomeContrato} de sócio usuário (colaborador), independentemente da entrada e/ou das parcelas pagas, quantia que será liquidada no ato da rescisão ou do cancelamento.
              </p>
              <p className="mb-3">
                <strong>PARÁGRAFO TERCEIRO:</strong> O presente contrato reveste-se e é aceito pelos contratantes com força de <strong>título executivo extrajudicial</strong>, constituindo dívida líquida, certa e exigível.
              </p>
              <p className="mb-6">
          ...
          <form onSubmit={handleConfirm} className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
                ...
                {(Object.keys(PLANOS) as PlanoKey[]).map((key) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-start px-3 py-2.5 border text-left transition-all cursor-pointer ${
                        active
            ...
            <div className="pt-2 space-y-4">
              ...
              <button
                ...
                className="w-full py-3 bg-gray-900 text-white text-sm font-medium tracking-wide hover:bg-gray-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2 cursor-pointer"
              >
                {loading ? (
