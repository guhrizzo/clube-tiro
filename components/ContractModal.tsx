...
import { X, CheckCircle, FileText, Lock, Printer, Download, Mail, Building2 } from "lucide-react";
...
// ── Signature Block ───────────────────────────────────────────────────────────
// Garante que TODAS as colunas tenham a mesma altura fixa (h-16) para o espaço
// da assinatura, com border-t e texto sempre alinhados na mesma posição.
function SigBlock({
  imgSrc,
  imgAlt,
  label,
  ...
  return (
    <div>
      {/* Área de assinatura: altura fixa, imagem encostada na base */}
      ...
      {/* Linha + texto: sempre na mesma posição vertical */}
...
export default function ContractModal({ isOpen, onClose }: ContractModalProps) {
  ...
  // ── Clone with computed styles (for print) ────────────────────────────────
...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    body { margin: 0; padding: 32px; background: #fff; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
    img { max-height: 56px !important; max-width: 180px !important; width: auto !important; height: auto !important; display: block; }
        ...
        >
          ...
          <div className="flex-[1.6] flex flex-col overflow-hidden border-r border-gray-200">
            ...
            <div className="flex-1 overflow-y-auto bg-gray-50 px-6 py-8" ref={scrollRef}>
              <div
                ref={contractRef}
                className="max-w-170 mx-auto bg-white border border-gray-200 px-10 py-12 text-[13px] text-gray-800 leading-relaxed font-serif shadow-sm"
              >
                {/* Título */}
                ...
                <p className="mb-4 text-justify">
                  ...
                  {blank("__/__/____", formData.nascimento ? new Date(formData.nascimento).toLocaleDateString("pt-BR") : "", "min-w-[90px]")},
                  doravante simplesmente denominado(a) <strong>SÓCIO USUÁRIO (COLABORADOR)</strong>, têm
                  entre si justo e contratado o direito de sócio usuário (colaborador) da PROTECT, tudo de
                  acordo com as condições especificadas nesta contratação/adesão e na legislação vigente.
                </p>
            ...
            <form onSubmit={handleConfirm} className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input required type="date" className={field} max={new Date().toISOString().split("T")[0]} value={formData.nascimento}
                  ...
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <div className="text-center space-y-0.5">
                      ...
                      <p className="text-[11px] text-gray-400 mt-1">
                        Valor: <span className="font-semibold text-gray-700">{p.parcela}</span>
                      </p>
                    </div>
