            ...
            <div data-aos="zoom-in" data-aos-delay="400" className="w-full">
                ...
                <div className="absolute top-4 right-8 z-30">
                    <button
                        ...
                        className="bg-white/10 hover:bg-[#ffc300ff] hover:text-black transition-all p-3 lg:mr-0 mr-4 rounded-full backdrop-blur-md border border-white/20 cursor-pointer"
                    >
